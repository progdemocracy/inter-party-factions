...
export function PartySelector() {
  ...
  return (
    ...
    <p className="text-base text-gray-700 leading-relaxed mb-16">    
      למה מוצגות דווקא 3 המפלגות האלה? כי רק הן קיימו 'פריימריז' לקראת הבחירות האחרונות וגם עברו את אחוז החסימה. החברים במפלגות אלה השתתפו בבחירות ישירות שקבעו חלק מחברי הכנסת והשרים המכהנים כיום.
    </p>
