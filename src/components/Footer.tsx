...
function PartyBanner({ selectedParty }: { selectedParty: Party }) {
  return (
    ...
    <div className="text-right mt-4 space-y-4 text-gray-800 text-base font-normal [&_p]:mt-0">
      ...
      <p>
      הופעה של קבוצה בדף זה לא מעידה על תמיכה של העמותה לדמוקרטיה מתקדמת בפעילותה, וגם להיפך - הופעה של קבוצה בדף זה לא מעידה על תמיכה שלה בעמותה לדמוקרטיה מתקדמת ואף לא על שיתוף פעולה כלשהו ביניהן. כל קבוצה המופיעה בדף זה עומדת בפני עצמה, ללא שהדבר מעיד על קשר בינה לבין קבוצות אחרות.
      </p>
